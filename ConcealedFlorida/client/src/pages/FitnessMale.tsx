...
export default function FitnessMale() {
  ...
  return (
    <>
      <SEOHead
        title="Men's Fitness Standards by Age | Concealed Florida"
        description="Detailed men's fitness standards across 7 categories — cardio, strength, endurance, flexibility, grip, body composition, and neuromotor — for every age group."
        path="/fitness/male"
      />
      <Layout>
        <div className="container mx-auto px-4 py-12 max-w-5xl">
          <div className="flex flex-wrap items-center justify-between gap-2 mb-8">
            <Button variant="secondary" size="sm" asChild>
              <Link href="/fitness" data-testid="link-back-fitness-male">
                <ArrowLeft className="w-4 h-4 mr-2" />
                Back to Training
              </Link>
            </Button>
            <Button variant="secondary" size="sm" asChild>
              <Link href="/training/videos" data-testid="link-video-resources-male">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-2" data-testid="heading-fitness-male">
            Men's Fitness Standards
          </h1>
          ...
          <div className="space-y-14">
            {fitnessCategories.map((cat) => (
              <section key={cat.num} id={`category-${cat.num}`}>
                        ...
                        <Fragment key={ag.key}>
                          <tr className="border-b border-gray-800/60 bg-black/20">
                            ...
                            <td className="py-3 px-4 text-center text-gray-200">
                              {maleStandards[ag.key].baseline[cat.key]}
                            </td>
                          </tr>
                          <tr className={i < ageGroups.length - 1 ? "border-b border-gray-700" : ""}>
                            ...
                            <td className="py-3 px-4 text-center text-white font-medium">
                              {maleStandards[ag.key].military[cat.key]}
                            </td>
                          </tr>
                        </Fragment>
                      ))}
                ...
                <FitnessDownloadBar catKey={cat.key} gender="male" catNum={cat.num} />
              </section>
            ))}
          </div>
          ...
          <div className="mt-14 pt-8 border-t border-gray-800">
            ...
            <Button variant="secondary" asChild>
              <Link href="/fitness" data-testid="link-back-bottom-male">
                <ArrowLeft className="w-4 h-4 mr-2" />
                Back to Training
              </Link>
            </Button>
